...
**文档来源**
- [docx.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/services/rag/doc_parser/docx.py#L5-L17)
...
**文档来源**
- [manager.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/core/models/manager.py#L57-L62)

### 批处理机制
向量化过程实现了智能批处理机制。对于少于等于10条的文本，直接处理；对于更多文本，则分成每组10条的批次，并通过信号量限制最大并发任务数为5，平衡了性能和资源消耗。

**文档来源**
- [embedding.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/services/rag/embedding.py#L24-L43)
...
**图示来源**
- [settings.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/settings.py#L8-L62)
- [common.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/schema/common.py#L33-L66)
...
**文档来源**
- [embedding.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/services/rag/embedding.py#L25-L26)
- [text.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/services/rag/doc_parser/text.py#L10-L11)
- [settings.py](https://github.com/Shy2593666979/AgentChat/tree/main/src/backend/agentchat/settings.py#L21-L22)
